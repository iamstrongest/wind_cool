import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, version, unref, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, ref, resolveComponent, computed, openBlock, createElementBlock, createElementVNode, warn, provide, renderSlot, watch, normalizeClass, normalizeStyle, withDirectives, cloneVNode, Fragment, Text, Comment, createVNode, createBlock, mergeProps, withCtx, createCommentVNode, Teleport as Teleport$1, Transition, vShow, readonly, toDisplayString, useSlots, resolveDynamicComponent, createTextVNode, useSSRContext, Suspense, nextTick, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
import "destr";
import "klona";
import { isClient, computedEager, tryOnScopeDispose, unrefElement, onClickOutside } from "@vueuse/core";
import { isString, isObject, hasOwn, NOOP, isFunction, isArray } from "@vue/shared";
import { fromPairs, pick, isNil, isUndefined as isUndefined$1 } from "lodash-unified";
...
const _routes = [
  {
    name: "about-details",
    path: "/about/details",
    component: () => import("./_nuxt/details-B7tIfN1C.js")
  },
  {
    name: "about",
    path: "/about.html",
    ...
    alias: ["/about"],
    component: () => import("./_nuxt/index-hPa9Dk4v.js")
  },
  {
    name: "index",
    path: "/index.html",
    ...
    alias: ["/", "/home"],
    component: () => import("./_nuxt/index-BNKnoRWx.js")
  },
  {
    name: "more",
    path: "/more.html",
    ...
    alias: ["/more"],
    component: () => import("./_nuxt/index-DWI0B2Kz.js")
  },
  {
    name: "user-id",
    path: "/user/:id()",
    component: () => import("./_nuxt/_id_-CfCxNwWA.js"),
    children: [
      {
        name: "user-id-collections",
        path: "collections",
        component: () => import("./_nuxt/index-oLVz-KgQ.js")
      },
      {
        name: "user-id-details",
        path: "details",
        component: () => import("./_nuxt/index-DegS_LPA.js")
      }
    ]
  },
  {
    name: "user-help",
    path: "/user/help",
    component: () => import("./_nuxt/help-D2grDFfG.js")
  },
  {
    name: "user",
    path: "/user",
    component: () => import("./_nuxt/index--FtRi1cA.js")
  },
  {
    name: "user-login",
    path: "/user/login.html",
    ...
    alias: ["/user/login"],
    component: () => import("./_nuxt/login-DAViYdJm.js")
  }
];
...
function storageFn(token, refresh_token, uuid) {
  if (token) {
...
const useGlboalStore = defineStore("glboal", () => {
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const userHref = computed(() => {
      var _a;
      return "/user/" + ((_a = glboalStore.state.userinfo) == null ? void 0 : _a.userId) + ".html";
    });
    function logout() {
      glboalStore.logout();
    }
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "header" }, _attrs))} data-v-9c837f36><nav data-v-9c837f36><li class="nav-left" data-v-9c837f36>`);
      ...
      _push(`</li><li class="nav-right" data-v-9c837f36>`);
      if ((_a = unref(glboalStore).state.userinfo) == null ? void 0 : _a.userId) {
        _push(ssrRenderComponent(_component_NuxtLink, {
          class: "link",
          to: unref(userHref)
        }, {
      ...
      _push(ssrRenderComponent(_component_el_popover, {
        ...
        reference: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_button, { class: "m-2" }, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<li class="more-li" data-v-9c837f36${_scopeId}>`);
            _push2(ssrRenderComponent(_component_NuxtLink, { to: "/about.html" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`关于`);
                } else {
            ...
            _push2(`</li><li class="more-li" data-v-9c837f36${_scopeId}>`);
            ...
            return [
              createVNode("li", { class: "more-li" }, [
                createVNode(_component_NuxtLink, { to: "/about.html" }, {
                  default: withCtx(() => [
                    createTextVNode("关于")
                  ]),
                  _: 1
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-9c837f36"]]);
    ...
    const apps = ref([
      {
        id: 1,
        text: "爱聊",
        href: "https://chat.wind-cool.top"
      },
      {
        id: 2,
        text: "轻量级共享健身",
        href: "https://share.wind-cool.top"
      }
    ]);
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<p${ssrRenderAttrs(_attrs)} data-v-8b54515d><span data-v-8b54515d>友情链接:</span><!--[-->`);
      ssrRenderList(unref(apps), (app) => {
        _push(`<span data-v-8b54515d><a${ssrRenderAttr("href", app.href)} target="_blank" data-v-8b54515d>${ssrInterpolate(app.text)}</a></span>`);
      });
      _push(`<!--]--><span data-v-8b54515d><a href="javascript:void(0);" data-v-8b54515d> 联系我: ${ssrInterpolate(info.email)}</a></span><span data-v-8b54515d><a href="https://beian.miit.gov.cn/" target="_blank" data-v-8b54515d>${ssrInterpolate(info.recordText)}</a></span></p>`);
    };
  }
};
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-8b54515d"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ id: "app" }, _attrs))}><header>`);
      _push(ssrRenderComponent(_component_Header, null, null, _parent));
      _push(`</header><main class="main">`);
      _push(ssrRenderComponent(_component_NuxtPage, null, null, _parent));
      _push(`</main><footer class="footer">`);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-Q5hEF3nM.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Cjgn27GL.js"));

...
<template>
    <div class="header">
        <nav>
            <li class="nav-left">
                <NuxtLink class="link" to="/index.html">主页</NuxtLink>
            </li>
            <li class="nav-right">
            ...
            <li class="more-li">
                <NuxtLink :to="userHref" v-if="glboalStore.state.userinfo?.userId">
                    个人信息
                </NuxtLink>
                <NuxtLink to="/user/login.html" v-else>前往登录</NuxtLink>
            </li>
            <li class="more-li">

import { version, unref, inject, ref, defineComponent, computed, provide, renderSlot, watch, openBlock, createElementBlock, normalizeClass, normalizeStyle, withDirectives, cloneVNode, Fragment, Text, Comment, createVNode, createBlock, mergeProps, withCtx, createCommentVNode, toRef, Transition, vShow, readonly, toDisplayString, resolveDynamicComponent, reactive, createTextVNode, useSSRContext, shallowReactive, h, Suspense, nextTick, resolveComponent, warn, useSlots, createApp, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, shallowRef, onErrorCaptured, onServerPrefetch, createElementVNode, Teleport as Teleport$1, defineAsyncComponent, isReadonly, toRaw, isRef, isShallow, isReactive } from 'vue';
import { $ as $fetch, k as defu, l as hasProtocol, m as isScriptProtocol, n as joinURL, p as parseQuery, o as createHooks, q as sanitizeStatusCode, e as createError$1, r as getContext, w as withQuery, v as withTrailingSlash, x as withoutTrailingSlash, y as toRouteMatcher, z as createRouter$1 } from '../_/nitro.mjs';
import { b as baseURL } from '../routes/renderer.mjs';
import { defineStore, createPinia, setActivePinia, shouldHydrate } from 'pinia';
import { getActiveHead, CapoPlugin } from 'unhead';
import { defineHeadPlugin } from '@unhead/shared';
import { RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { computedEager, onClickOutside, isClient, tryOnScopeDispose, unrefElement } from '@vueuse/core';
import { NOOP, isObject, isString, hasOwn, isFunction, isArray } from '@vue/shared';
import { isNil, fromPairs, pick, isUndefined as isUndefined$1 } from 'lodash-unified';
...
const _routes = [
  {
    name: "about-details",
    path: "/about/details",
    component: () => import('./details-B7tIfN1C.mjs')
  },
  {
    name: "about",
    path: "/about.html",
    ...
    alias: ["/about"],
    component: () => import('./index-hPa9Dk4v.mjs')
  },
  {
    name: "index",
    path: "/index.html",
    ...
    alias: ["/", "/home"],
    component: () => import('./index-BNKnoRWx.mjs')
  },
  {
    name: "more",
    path: "/more.html",
    ...
    alias: ["/more"],
    component: () => import('./index-DWI0B2Kz.mjs')
  },
  {
    name: "user-id",
    path: "/user/:id()",
    component: () => import('./_id_-CfCxNwWA.mjs'),
    children: [
      {
        name: "user-id-collections",
        path: "collections",
        component: () => import('./index-oLVz-KgQ.mjs')
      },
      {
  ...
  },
  {
    name: "user-help",
    path: "/user/help",
    component: () => import('./help-D2grDFfG.mjs')
  },
  {
    name: "user",
    path: "/user",
    component: () => import('./index--FtRi1cA.mjs')
  },
  {
    name: "user-login",
    path: "/user/login.html",
    ...
    alias: ["/user/login"],
    component: () => import('./login-DAViYdJm.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Q5hEF3nM.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Cjgn27GL.mjs'));
